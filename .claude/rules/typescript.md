...
- Correr el linter/type-checker del proyecto (`pnpm build`, que incluye type-check de Next.js).
- Correr el gate de tests definido en `tests.md`.
- Verificar que no quedaron `console.log`/`print` de debug.
