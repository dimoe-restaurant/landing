    ...
    <section id="menu" style={{ background: '#0D0B09', padding: '96px 24px' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          gap: '24px', flexWrap: 'wrap', marginBottom: '48px',
        }}>
          <motion.div
          ...
          <motion.a
            ...
            style={{
              flexShrink: 0, background: '#C17A3B', color: '#F2EDE4',
              padding: '12px 28px', borderRadius: '100px', fontSize: '14px',
        ...
        <motion.div
          ...
          style={{
            marginTop: '24px',
            background: '#181310',
            border: '1px solid rgba(193,122,59,0.25)',
            borderRadius: '14px',
            padding: '24px 32px',
            textAlign: 'center',
          }}
