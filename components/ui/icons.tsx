// SVG icon components — inline, sin dependencias externas
...
export function IconWhatsApp({ size = 18, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden className={className}>
...
export function IconEmail({ size = 18, className }: { size?: number; className?: string }) {
  return (
...
export function IconMapPin({ size = 14, className }: { size?: number; className?: string }) {
  return (
...
export function IconCar({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden className={className}>
